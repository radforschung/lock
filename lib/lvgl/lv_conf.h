...
#define LV_HOR_RES (200)
#define LV_VER_RES (200)
#define LV_DPI 100
...
//#define LV_VDB_SIZE
//(40 * LV_HOR_RES) //Size of VDB in pixel count (1/10 screen size is good for
...
#define USE_LV_REAL_DRAW                                                       \
  0 /*1: Enable function which draw directly to the frame buffer instead of    \
